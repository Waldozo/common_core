...
/*   Updated: 2025/01/30 18:23:00 by wlarbi-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv)
{
	...
	if(map_size(data.map) == 1 && map_things(&data) == 1 && map_error_top_bottom(data.map) == 1 && map_error_sides(data.map) == 1 && map_error(data.map) == 1)
